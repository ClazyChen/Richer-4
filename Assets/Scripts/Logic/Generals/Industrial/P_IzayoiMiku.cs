...
public class P_IzayoiMiku: PGeneral {
    ...
    public P_IzayoiMiku() : base("诱宵美九") {
        ...
        Tips = "定位：攻击\n" +
            ...
            "攻略：\n独奏可以压制住全部的防御牌，既不能被闪避也不能被减伤，还无法通过借尸还魂、走为上计自救，一定程度上使得项羽、廉颇、屈原一类的自伤角色不敢铤而走险。如果美九有古锭刀，则每一次过路费都触发古锭刀技能的效果，从而成为很强的火力点。新版美九的独奏无法触发花木兰的枭姬，但花木兰仍可以通过易装给她古锭刀来形成配合。\n美九的团队通常需要建一座城堡给轮舞曲。如果在未来大概率拿不到新的商业用地的情况下，即使是3级城堡，在轮舞曲之后也相当于免费升了2级的购物中心。";
