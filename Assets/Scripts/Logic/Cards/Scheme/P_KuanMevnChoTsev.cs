...
public class P_KuanMevnChoTsev: PSchemeCardModel {
    ...
    public List<PPlayer> AIEmitTargets(PGame Game, PPlayer Player) {
        return Game.PlayerList.FindAll((PPlayer _Player) => _Player.Position.HouseNumber == 0 && !_Player.Equals(Player) && _Player.IsAlive);
    }
