public class PBusinessType : PObject
{
    ...
    public static PBusinessType Pawnshop = new PBusinessType("当铺", "一名角色停留于此时，可交给领主1张手牌并摸2000。"); // 已废除
    ...
    public static PBusinessType Altar = new PBusinessType("祭坛", "一名角色经过此时，你可以令其弃1000。");
}
